...
{
    public class SexMatchViewModel : BindableBase
    {
        public SexMatchViewModel(PatientDoctorDto model = null) => Model = model ?? new PatientDoctorDto();
        ...
        {
            get => Model.Doctor.Sex;
            set
            {
                if (value != Model.Doctor.Sex)
                {
                    Model.Doctor.Sex = value;
                    IsModified = true;
                    OnPropertyChanged();
                }
            }
        ...
        {
            get => Model.Patient.Sex;
            set
            {
                if (value != Model.Patient.Sex)
                {
                    Model.Patient.Sex = value;
                    IsModified = true;
                    OnPropertyChanged();
                }
            }
        ...
        public async Task SaveAsync()
        {
            ...
            {
                IsNewMatch = false;
                App.ViewModel.SexMatches.Add(this);
            }
